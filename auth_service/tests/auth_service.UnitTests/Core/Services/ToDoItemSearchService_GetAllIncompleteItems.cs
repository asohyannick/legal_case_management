...
using auth_service.Core.ProjectAggregate;
using auth_service.Core.Services;
using auth_service.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace auth_service.UnitTests.Core.Services
{
